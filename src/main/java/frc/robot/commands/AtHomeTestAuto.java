...
public class AtHomeTestAuto extends SequentialCommandGroup implements AutoCommandInterface {
    ...
    public AtHomeTestAuto(DriveTrain robotDrive, DriveCommand drivecommand) {
        drivecommand.cancel();
