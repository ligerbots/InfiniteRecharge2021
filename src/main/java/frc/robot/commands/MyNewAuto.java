...
public class MyNewAuto extends SequentialCommandGroup implements AutoCommandInterface {
    ...
    public MyNewAuto(DriveTrain robotDrive, Path autoID, Climber climber) {
