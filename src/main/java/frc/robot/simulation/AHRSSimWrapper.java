...
public class AHRSSimWrapper extends AHRS {
  ...
  public AHRSSimWrapper(SPI.Port kmxp, byte update_rate_hz) {
    ...
    if (m_simDevice != null) {
      m_simAngle = m_simDevice.createDouble("Angle", Direction.kInput, 0.0);
      m_simRate = m_simDevice.createDouble("Rate", Direction.kInput, 0.0);
      m_simPitch = m_simDevice.createDouble("Pitch", Direction.kInput, 0.0);
    }
  }
