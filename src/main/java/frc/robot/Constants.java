...
public final class Constants {
    ...
    public static final double CAROUSEL_GS_SHOOTER_SPEED = 0.4; // This is just percent output
    public static final double CAROUSEL_INTAKE_SPEED = 0.8; // This is just percent output
    public static final int CAROUSEL_MAX_BALLS = 4;
    ...
    public static final int CAROUSEL_FIFTH_ROTATION_TICKS = 12615; // Calibrated Feb 17, 2021
